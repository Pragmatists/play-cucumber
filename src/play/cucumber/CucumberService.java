...
public class CucumberService {
    ...
    public CucumberFeature findFeatureByUri(String uri) {
    ...
    public List<RunResult> runAllFeatures(PrintStream consoleStream) {
        List<CucumberFeature> features = loadFeatures();
    ...
    public RunResult runFeature(String uri) {
    ...
    private RunResult runFeature(CucumberFeature cucumberFeature, Formatter... formatters) {
    ...
    private RunResult serializeExecutionResult(CucumberFeature cucumberFeature,
    ...
    private List<ErrorDetail> buildErrors(List<Throwable> failures) {
    ...
    private class ExecFeature {
        ...
        public ExecFeature exec() {
            ...
            runtime = new Runtime(resourceLoader, classLoader, asList(backend), runtimeOptions);
